...
const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  const [activeTab, setActiveTab] = useState<
    "General" | "Speedometers" | "Status"
  >("General");

  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="mt-2">
        <div className="w-[1288.32px] h-[36.51px] p-[2.79px] bg-gradient-to-r from-neutral-950 via-neutral-900 to-neutral-950 rounded-md justify-start items-start inline-flex">
          <div
            onClick={() => setActiveTab("General")}
            className="grow shrink basis-0 p-[6.97px] bg-gradient-to-l from-white to-indigo-50 shadow flex-col justify-start items-start gap-[6.97px] inline-flex"
          >
            <div className="self-stretch text-center text-gray-950 text-sm font-bold font-['Inter']">
              General Settings
            </div>
          </div>
          <div
            onClick={() => setActiveTab("Speedometers")}
            className="grow shrink basis-0 p-[6.97px] flex-col justify-start items-start gap-[6.97px] inline-flex"
          >
            <div className="self-stretch text-center text-neutral-400 text-sm font-medium font-['Inter']">
              Speedometers
            </div>
          </div>
          <div
        ...
        <>
          <div className="flex flex-col gap-y-2">
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[163px] h-[45px] left-[112px] top-[21px] absolute">
                <div className="left-0 top-0 absolute text-center text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Cinematic Mode
                </div>
                <div className="left-[2px] top-[30px] absolute text-center text-zinc-500 text-xs font-semibold font-['Inter']">
                  Off-On Settings
                </div>
              </div>
            </div>
            <div className="w-[1197px] h-[87px] relative">
              <div className="w-[1197px] h-[87px] left-0 top-0 absolute bg-zinc-300 bg-opacity-5 rounded-[5px]" />
              <div className="w-[134.58px] h-[49.03px] pl-[9px] pr-4 py-[5.01px] left-[1041.64px] top-[18.31px] absolute bg-white bg-opacity-0 rounded-lg border border-white border-opacity-10 backdrop-blur-[12.71px] justify-start items-center gap-[26.04px] inline-flex">
                <div className="pl-[17.02px] pr-[18.53px] py-[7.01px] bg-neutral-200 bg-opacity-10 rounded-lg shadow border-2 border-neutral-200 justify-start items-start flex">
                  <div className="text-neutral-200 text-[13.02px] font-bold font-['Satoshi'] leading-normal tracking-tight">
                    ON
                  </div>
              ...
              <div className="w-[148px] h-[45px] left-[114px] top-[21px] absolute">
                <div className="left-0 top-0 absolute text-center text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Show Location
                </div>
            ...
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[173.86px] h-[49.03px] pl-[19.03px] pr-[11.25px] py-[5.01px] left-[851px] top-[18.31px] absolute bg-white bg-opacity-0 rounded-lg border border-white border-opacity-10 backdrop-blur-[12.71px] justify-start items-center gap-[26.04px] inline-flex">
                <div className="text-zinc-500 text-sm font-medium font-['Satoshi'] leading-[14.02px] tracking-tight">
                  Circle
                </div>
                <div className="pl-[17.02px] pr-[18.53px] py-[7.01px] bg-neutral-200 bg-opacity-10 rounded-lg shadow border-2 border-neutral-200 justify-start items-start flex">
              ...
              <div className="w-[91px] h-[43px] left-[114px] top-[23px] absolute">
                <div className="left-0 top-0 absolute text-center text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Minimap
                </div>
            ...
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[196px] h-[43px] left-[114px] top-[23px] absolute">
            ...
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[123px] h-[43px] left-[114px] top-[23px] absolute">
                <div className="left-0 top-0 absolute text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Hide All Hud
                </div>
                <div className="left-0 top-[28px] absolute text-center text-zinc-500 text-xs font-semibold font-['Inter']">
            ...
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[166px] h-[43px] left-[114px] top-[23px] absolute">
                <div className="left-0 top-0 absolute text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Restore Defaults
                </div>
                <div className="left-0 top-[28px] absolute text-center text-zinc-500 text-xs font-semibold font-['Inter']">
            ...
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[171px] h-[43px] left-[114px] top-[23px] absolute">
                <div className="left-0 top-0 absolute text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Hide User Money
                </div>
                <div className="left-0 top-[28px] absolute text-center text-zinc-500 text-xs font-semibold font-['Inter']">
            ...
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[179px] h-[43px] left-[114px] top-[23px] absolute">
                <div className="left-0 top-0 absolute text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Hide Online Users
                </div>
                <div className="left-0 top-[28px] absolute text-center text-zinc-500 text-xs font-semibold font-['Inter']">
            ...
            <div className="w-[1197px] h-[87px] relative">
              ...
              <div className="w-[172px] h-[43px] left-[114px] top-[23px] absolute">
                <div className="left-0 top-0 absolute text-neutral-400 text-[21.25px] font-semibold font-['Inter']">
                  Hide Server Logo
                </div>
                <div className="left-0 top-[28px] absolute text-center text-zinc-500 text-xs font-semibold font-['Inter']">
