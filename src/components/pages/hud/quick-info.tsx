  ...
  return (
    <div className="flex flex-col gap-y-2">
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="w-[163.10px] h-[29.85px] relative">
          <div className="w-[163.10px] h-[29.85px] left-0 top-0 absolute opacity-90 bg-black rounded" />
          <div className="left-[33.05px] top-[7.46px] absolute text-center">
        ...
        <div className="w-[163.10px] h-[29.85px] relative">
          <div className="w-[163.10px] h-[29.85px] left-0 top-0 absolute opacity-90 bg-black rounded" />
          <div className="left-[33.05px] top-[7.46px] absolute">
            <span className="text-neutral-400 text-[11.11px] font-semibold font-['Orbitron']">
              CASH :
            </span>
            <span className="text-white text-[11.11px] font-semibold font-['Orbitron']">
