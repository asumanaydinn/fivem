      ...
      <div className="flex flex-col gap-y-8">
        <div className="flex flex-col gap-y-2 relative">
          <input
            ...
            type="number"
            value={
              visibilityThresholds["health" as keyof VibisilityThresholds] || ""
            }
          ...
          <input
            ...
            type="number"
            value={
              visibilityThresholds["armor" as keyof VibisilityThresholds] || ""
            }
          ...
          <input
            ...
            type="number"
            value={
              visibilityThresholds["stress" as keyof VibisilityThresholds] || ""
            }
          ...
          <input
            ...
            type="number"
            value={
              visibilityThresholds["hunger" as keyof VibisilityThresholds] || ""
            }
          ...
          <input
            ...
            type="number"
            value={
              visibilityThresholds["hydration" as keyof VibisilityThresholds] ||
              ""
            }
          ...
          <input
            ...
            type="number"
            value={
              visibilityThresholds["energy" as keyof VibisilityThresholds] || ""
            }
