      ...
      <div className="flex items-center w-full justify-between p-2">
        <div className="flex gap-x-2 items-center">
          ...
          <div className="flex flex-col">
            <div className=" text-neutral-400 text-[32.97px] font-bold font-['Qanelas Soft']">
              SETTINGS
            </div>
            <div className="text-neutral-400 text-lg font-semibold font-['Qanelas Soft']">
              Dusa Hud | www.devdusa.tebex.io
            </div>
          </div>
        </div>
        <div className="flex flex-col gap-y-2">
          <div className="flex gap-x-2 items-center">
            <div className="text-center p-2 rounded-[0.89px] bg-white text-black text-xs font-bold font-['Inter']">
              ESC
            </div>
            <div className="text-center text-neutral-400 text-sm font-medium font-['Inter']">
              Exit Settings
            </div>
          </div>
          <div className="flex gap-x-2 items-center">
            <div className="text-center rounded-[0.89px] p-2 bg-white text-black text-xs font-bold font-['Inter']">
              CLICK
            </div>
            <div className="text-center text-neutral-400 text-sm font-medium font-['Inter']">
              to Save Settings
