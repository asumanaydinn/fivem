...
const SpeedFuelGauge: React.FC<SpeedFuelGaugeProps> = ({
  speed,
  maxSpeed,
  fuel,
  maxFuel,
  ...
  return (
    <>
      <div className="w-[102.62px] shadow shadow-purple-400 relative flex items-center justify-center  h-[102.62px] bg-gradient-to-b from-neutral-900 via-neutral-800 to-zinc-950 rounded-full border border-white border-opacity-10">
        <canvas
          className="-rotate-90"
          ref={canvasRef}
          width="132"
