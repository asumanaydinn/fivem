const SpeedoMeter3 = () => {
  return (
    <div className="w-[142.99px] h-[142.99px] relative">
      <div className="w-[102.62px] h-[102.62px] z-10 left-[20.18px] top-[20.19px] absolute bg-gradient-to-b from-neutral-900 via-neutral-800 to-zinc-950 rounded-full border border-white border-opacity-10" />
      <div className="left-[66.65px] top-[107.86px] z-10 absolute text-white text-[8.25px] font-medium font-['Orbitron']">
        2
      </div>
      <div className="left-[78.77px] top-[110.02px] z-10 absolute text-neutral-400 text-[4.85px] font-medium font-['Orbitron']">
        3
      </div>
      <div className="left-[59.78px] top-[110.02px] z-10 absolute text-neutral-400 text-[4.85px] font-medium font-['Orbitron']">
        1
      </div>
      <div className="w-[62px] h-[39.69px] left-[40.39px] top-[42px] absolute z-10">
